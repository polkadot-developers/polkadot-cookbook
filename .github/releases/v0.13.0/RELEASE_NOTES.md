...
> Three new documentation test harnesses, a Claude Code devcontainer, and a major upgrade to the release skill.
...
- Enhanced **/release skill** with professional open-source standards: CHANGELOG.md generation, contributor credits, breaking change detection, full diff links, and migration notes
...
**22 commits, 3 contributors, +23,744 / -1,395 lines**
