...
const REPO_URL = "https://github.com/brunopgalvao/recipe-paseo-local-network";
const REPO_VERSION = "v1.0.0";
const REPO_DIR = join(PROJECT_DIR, "recipe-paseo-local-network");

describe("Paseo Local Network Recipe", () => {
  // ==================== PREREQUISITES ====================
  ...
  describe("2. Clone Repository", () => {
    it("should clone the recipe repository", () => {
      if (existsSync(REPO_DIR)) {
        ...
        console.log(`Cloning recipe-paseo-local-network ${REPO_VERSION}...`);
