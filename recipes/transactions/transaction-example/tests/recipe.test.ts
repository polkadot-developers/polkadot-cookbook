...
const REPO_URL = "https://github.com/brunopgalvao/recipe-transaction-example";
const REPO_VERSION = "v1.0.0";
const REPO_DIR = join(PROJECT_DIR, "recipe-transaction-example");

describe("Transaction Example Recipe", () => {
  // ==================== PREREQUISITES ====================
  ...
  describe("2. Clone Repository", () => {
    it("should clone the recipe repository", () => {
      if (existsSync(REPO_DIR)) {
        ...
        console.log(`Cloning recipe-transaction-example ${REPO_VERSION}...`);
