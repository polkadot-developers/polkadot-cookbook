...
const REPO_URL = "https://github.com/brunopgalvao/recipe-contracts-precompile-example";
const REPO_VERSION = "v1.1.0";
const REPO_DIR = join(PROJECT_DIR, "recipe-contracts-precompile-example");

describe("Contracts Precompile Example Recipe", () => {
  // ==================== PREREQUISITES ====================
  ...
  describe("2. Clone Repository", () => {
    it("should clone the recipe repository", () => {
      if (existsSync(REPO_DIR)) {
        ...
        console.log(`Cloning recipe-contracts-precompile-example ${REPO_VERSION}...`);
  ...
  describe("5. Run Tests", () => {
    it("should pass all Hardhat tests against Asset Hub via Zombienet + eth-rpc", () => {
      console.log("Running Hardhat tests on Asset Hub (Zombienet) via eth-rpc...");
