...
const REPO_URL = "https://github.com/papermoonio/openzeppelin-contracts-revm.git";
const REPO_BRANCH = "revm";
const REPO_COMMIT = "6c5c93fc5092fc5400414c5a3e5c2b2edb4f6e27";

describe("OpenZeppelin Contracts REVM Migration", () => {
  ...
  describe("2. Clone Repository", () => {
    it("should clone openzeppelin-contracts-revm at pinned commit", () => {
      // Clean up if exists
